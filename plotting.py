...
#         self.colors = ["#A67B5B", "#4B3621", "#ddd1b1"]
        ...
        # # used in paper revision May 17
    
        # # orange, purple, green
#         self.colors = ["#1b9e77", "#7570b3", "#d95f02"]
#         self.colors = ["#006d6c", "#af58ba", "#009ade"]
        self.colors = [ "#000000", "#A9A9A9", "#D3D3D3"]
#         self.colors = [  "#D3D3D3", "#A9A9A9","#000000"]
...
#             ecolors = ["#767676", "#636363", "#4f4f4f", "#3b3b3b", "#282828", "#141414"]
            ...
            for name, grp in df_grp:
                ...
                ax.errorbar(grp['thetai'], grp['mean'], grp[self.err], label = name, fmt = emarks[m], alpha=0.9, mec = 'white', mfc=ecolors[m], markersize = 20, fillstyle=None, ecolor = ecolors[m], elinewidth = 2, capsize = 0)
#                 if name in ["Irnini", "Anala", "Didilia", "Pavlova"]:
# #                     ax.errorbar(grp['thetai'], grp['mean'], grp[self.err], label = name, fmt = emarks[m], alpha=0.9, mec = inc_ecolors, mfc=inc_fcolors, markersize = 18, fillstyle=None, ecolor = inc_fcolors, elinewidth = 2.5, capsize = 0)
#                     ax.errorbar(grp['thetai'], grp['mean'], grp[self.err], label = name, fmt = emarks[m], alpha=0.9, mec = 'white', mfc='k', markersize = 15, fillstyle=None, ecolor = inc_fcolors, elinewidth = 2.5, capsize = 0)
#                 else:
#                     ax.errorbar(grp['thetai'], grp['mean'], grp[self.err], label = name, fmt = emarks[m], alpha=0.7, mec = 'k', mfc=ecolors[m], markersize = 15, ecolor = "darkgray", elinewidth = 2.5, capsize = 0)
                m+=1
...
#             ecolors = ["#767676", "#636363", "#4f4f4f", "#3b3b3b", "#282828", "#141414"]
            ...
            for name, grp in df_grp:
                ax.errorbar(grp['thetai'], grp['mean'], grp[self.err], label = name, fmt = emarks[m], alpha=0.9, mec = 'white', mfc=ecolors[m], markersize = 20, fillstyle=None, ecolor = ecolors[m], elinewidth = 2, capsize = 0)
#                 if name in ["Irnini", "Anala", "Didilia", "Pavlova"]:
#                     ax.errorbar(grp['thetai'], grp['mean'], grp[self.err], label = name, fmt = emarks[m], alpha=0.9, mec = inc_ecolors, mfc=inc_fcolors, markersize = 1, fillstyle=None, ecolor = inc_fcolors, elinewidth = 2.5, capsize = 0)
#                 else:
#                     ax.errorbar(grp['thetai'], grp['mean'], grp[self.err], label = name, fmt = emarks[m], alpha=0.7, mec = 'k', mfc=ecolors[m], markersize = 1, ecolor = "darkgray", elinewidth = 2.5, capsize = 0)
                m+=1
...
#             thi, mean, std = self.Magfromcsv(data)
            ...
            m = 0
            for name, grp in df_grp:
                ax.errorbar(grp['thetai'], grp['mean'], grp[self.err], label = name, fmt = emarks[m], alpha=0.7, mec = 'k', mfc=ecolors[m], markersize = 8, ecolor = "darkgray", elinewidth = 2.5, capsize = 0)
                m+=1
